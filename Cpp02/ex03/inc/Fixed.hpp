...
/*   Updated: 2024/07/12 17:11:16 by tquemato         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Fixed {
	...
	public:
		...
		static Fixed min(Fixed &a, Fixed &b); //Static function to find the smallest fixed point number
		static Fixed min(const Fixed &a, const Fixed &b); //Static function to find the smallest constant fixed point
		static Fixed max(Fixed &a, Fixed &b); //Static function to find the largest fixed point number
		static Fixed max(const Fixed &a, const Fixed &b); //Static function to find the largest constant fixed point number
};
